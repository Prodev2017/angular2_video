...
export class EditorTracksComponent {
  ...
  newCollection:any = {name: "", description: ""};
    ...
    {label:'All-Time Download Count', value: 'allTimeDownloadCount'},
    {label:'Year', value:'year'},
    {label:'Time', value:'time'}
  ];
  
  trackColumnsSelected:Array<any> = ['added','editor','artist','bpm','key','tags','genres','year','time', 'downloadCountForPeriod','allTimeDownloadCount'];

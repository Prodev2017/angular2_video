import {NgModule,
  ...
  AfterContentInit,AfterViewInit,AfterViewChecked,OnInit,
  OnDestroy,DoCheck,Input,ViewContainerRef,
  ViewChild,
  Output,SimpleChange,
  EventEmitter,
  ContentChild,
  ContentChildren,
  Renderer,IterableDiffers,QueryList,TemplateRef,
  ChangeDetectorRef,
  Inject,
  forwardRef
  } from '@angular/core';
...
import {LazyLoadEvent,FilterMetadata,SortMeta} from '../../../../../../node_modules/primeng/components/common/api';
import {DomHandler} from '../../../../../../node_modules/primeng/components/dom/domhandler';
import {Subscription} from 'rxjs/Subscription';
import {BlockableUI} from '../../../../../../node_modules/primeng/components/common/api';
import {throttle} from '../../../../theme/utils/throttle';
...
export class TableBody {
  ...
  visibleColumns() {
    console.log('visibleColumns', this);
...
@Component({
  ...
  template: `
    ...
    <div #scrollBody class="ui-datatable-scrollable-body" [ngStyle]="{'width': width,'max-height':dt.scrollHeight}" (scroll)="dt.onScroll($event)">
      <div [ngStyle]="{'height.px': dt.totalRecords * 78}">
        <table [class]="dt.tableStyleClass" [ngStyle]="dt.tableStyle">
...
export class DataTable implements AfterViewChecked,AfterViewInit,AfterContentInit,OnInit,DoCheck,OnDestroy {
  ...
  ngOnInit() {
    ...
    this.throttledCheck = this.createThrottledChecks();
  }
  ...
  createThrottledChecks() {
    return throttle(() => {
      ...
      this.scrollWrapStyle = {
        height: 78 * this.totalRecords + 'px'
      };
    }, 2000);
...
export class DataTableVirtualScrollModule { }

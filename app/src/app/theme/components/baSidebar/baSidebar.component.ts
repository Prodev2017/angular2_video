...
export class BaSidebar {
  ...
  constructor(private _elementRef:ElementRef, private _state:GlobalState, public currency:Currency) {
  ...
  public updateSidebarHeight():void {
    ...
    this.menuHeight = this._elementRef.nativeElement.parentNode.clientHeight;
  }
